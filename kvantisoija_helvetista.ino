...
int ScaleQTY = 18;  //update these and size of the array if you add more scales!
int MaxNoteQTY = 24;  //there's probably a way to automate that, shame the coder who made this sucks
int ScaleID = 0; 
...
void loop() {
  ...
  Serial.println(ADAC); 
  mcp.setChannelValue(MCP4728_CHANNEL_A, ADAC);
  ...
  mcp.setChannelValue(MCP4728_CHANNEL_B, BDAC);
  ...
  mcp.setChannelValue(MCP4728_CHANNEL_C, CDAC);
  ...
  mcp.setChannelValue(MCP4728_CHANNEL_D, DDAC);
